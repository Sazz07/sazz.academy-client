            ...
            <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
                ...
                <div className="mt-4 mb-8 space-y-4">
                    <details className="w-full border rounded-lg">
                        ...
                        <p className="px-4 py-6 pt-0 ml-4 -mt-4 text-gray-900">This site is about online learning. You can learn various things on various topics from here. <br /> We have some great courses on some some popular topics. This is absolutely a free site. <br /> All you need to do is create an account. Logged in and get accessed to our courses.
                        </p>
                    </details>
                    <details className="w-full border rounded-lg">
                        <summary className="px-4 py-6 text-xl focus:outline-none focus-visible:ring-violet-400">2. Is this site secured?</summary>
                        <p className="px-4 py-6 pt-0 ml-4 -mt-4 text-gray-900">Yes, This is a very secured site. You can easily sign up to our site. <br /> This site is created using firebase. You can login to our site by using your Google or Github Account. <br /> No personal information going to be leaked from our site.
                        </p>
                    </details>
                    <details className="w-full border rounded-lg">
                        <summary className="px-4 py-6 text-xl focus:outline-none focus-visible:ring-violet-400">3. How do I take a course? </summary>
                        <p className="px-4 py-6 pt-0 ml-4 -mt-4 text-gray-900">It's very simple. First, create an account and then make sure to logged in. <br />
